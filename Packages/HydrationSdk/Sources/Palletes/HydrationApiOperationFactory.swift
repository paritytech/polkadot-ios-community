...
public protocol HydrationApiOperationFactoryProtocol {
...
public final class HydrationApiOperationFactory {
    let runtimeConnectionStore: RuntimeConnectionStoring
    let operationQueue: OperationQueue

    let stateCallFactory = StateCallRequestFactory()

    public init(runtimeConnectionStore: RuntimeConnectionStoring, operationQueue: OperationQueue) {
...
extension HydrationApiOperationFactory: HydrationApiOperationFactoryProtocol {
    public func createCurrencyBalanceWrapper(

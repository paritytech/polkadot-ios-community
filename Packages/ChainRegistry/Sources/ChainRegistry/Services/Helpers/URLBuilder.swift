...
public protocol URLBuilderProtocol {
    ...
    func buildURL(with parameters: some Encodable) throws -> URL
...
public final class URLBuilder {
    ...
    private func byEncoding(string: String) throws -> String {
        ...
        guard let encodedString = string
            .addingPercentEncoding(withAllowedCharacters: encodingCharset)
        else {
...
extension URLBuilder: URLBuilderProtocol {
    ...
    public func buildURL(with parameters: some Encodable) throws -> URL {
    ...
    public func buildBy(closure: (String) throws -> String) throws -> URL {

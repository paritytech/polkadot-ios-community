...
struct RecoveryPassTests {
    ...
    func propagationNothingToTerminal() async throws {
        ...
        let entry = DurabilityEntry.fixture(
            inputs: [.coin(.own(1))],
            outputs: [.coin(2)],
    ...
    func threeChainPromotesOverMultiplePasses() async throws {
        ...
        let entry2 = DurabilityEntry.fixture(inputs: [.coin(.own(1))], outputs: [.coin(2)])
        try await store.register(entry2)

        let entry3 = DurabilityEntry.fixture(inputs: [.coin(.own(2))], outputs: [.coin(3)])
    ...
    func abortedPassLeavesWorkUndone() async throws {
        ...
        let entry2 = DurabilityEntry.fixture(outputs: [.coin(2)])
        try await store.register(entry2)

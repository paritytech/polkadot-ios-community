...
enum ExtrinsicAssetConversionFeeEstimatorError: Error {
    case brokenFee
}

public final class ExtrinsicAssetConversionFeeEstimator {
...
extension ExtrinsicAssetConversionFeeEstimator: ExtrinsicFeeEstimating {
    public func createFeeEstimatingWrapper(
        ...
        guard
            let nativeAssetId = chainAsset.chainInterface.utilityChainAssetId() else {
            return CompoundOperationWrapper.createWithError(
                ExtrinsicAssetConversionFeeEstimatorError.brokenFee
            )
        }

...
public extension XcmUni {
    struct DepositAssetValue: Equatable {
        public let assets: AssetFilter
        public let maxAssets: UInt32
        public let beneficiary: RelativeLocation
    ...
    struct BuyExecutionValue: Equatable {
        public let fees: Asset
        public let weightLimit: WeightLimit

        public init(fees: Asset, weightLimit: WeightLimit) {
            self.fees = fees
    ...
    struct DepositReserveAssetValue: Equatable {
        public let assets: AssetFilter
        public let dest: RelativeLocation
        public let maxAssets: UInt32
        public let xcm: Instructions
    ...
    struct InitiateReserveWithdrawValue: Equatable {
        public let assets: AssetFilter
        public let reserve: RelativeLocation
        public let xcm: Instructions

        public init(assets: AssetFilter, reserve: RelativeLocation, xcm: Instructions) {
            self.assets = assets
    ...
    struct InitiateTeleportValue: Equatable {
        ...
        public init(assets: AssetFilter, dest: RelativeLocation, xcm: Instructions) {
            self.assets = assets
            self.dest = dest
            self.xcm = xcm
        }
...
extension XcmUni.Instruction: XcmUniCodable {
    public static let fieldWithdrawAsset = "WithdrawAsset"
    public static let fieldClearOrigin = "ClearOrigin"
    public static let fieldReserveAssetDeposited = "ReserveAssetDeposited"
    public static let fieldBuyExecution = "BuyExecution"
    public static let fieldDepositAsset = "DepositAsset"
    public static let fieldDepositReserveAsset = "DepositReserveAsset"
    public static let fieldReceiveTeleportedAsset = "ReceiveTeleportedAsset"
    public static let fieldBurnAsset = "BurnAsset"
    public static let fieldInitiateReserveWithdraw = "InitiateReserveWithdraw"
    public static let fieldInitiateTeleport = "InitiateTeleport"

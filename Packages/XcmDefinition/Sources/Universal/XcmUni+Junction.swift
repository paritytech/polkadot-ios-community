...
public extension XcmUni {
    ...
    struct AccountId32: Equatable {
        ...
        public init(network: NetworkId, accountId: AccountId) {
...
extension XcmUni.NetworkId: XcmUniCodable {
    ...
    public func encodeAny(to encoder: any Encoder, configuration: Xcm.Version) throws {

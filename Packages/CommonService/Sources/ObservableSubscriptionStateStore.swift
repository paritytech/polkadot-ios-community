...
public protocol ObservableSubscriptionStateStoreProtocol: ApplicationServiceProtocol {}

public typealias EquatableObservableSubscriptionState = Equatable & ObservableSubscriptionStateProtocol

public class ObservableSubscriptionStateStore<T: EquatableObservableSubscriptionState>: BaseObservableStateStore<T> {

...
public protocol NestedCallMapperProtocol {
    func map(
        call: JSON,
...
public enum NestedCallMapperError: Error {
...
public final class NestedCallMapper {
    public init() {}

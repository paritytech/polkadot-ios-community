...
public struct SkeletonableViewReplica {
    public let count: UInt32
    public let spacing: CGFloat

    public init(count: UInt32, spacing: CGFloat) {
        self.count = count
        self.spacing = spacing
    }
}

public struct SkeletonableViewStyle {
...
public protocol SkeletonableView: UIView {
    ...
    var skeletonStyle: SkeletonableViewStyle { get }
    ...
    private func setupSkeleton() {
        ...
        if let skeletonView {
            ...
            let newSkeletonView = builder
                .fillSkeletonStart(skeletonStyle.startColor)
                .fillSkeletonEnd(color: skeletonStyle.endColor)
                .build()

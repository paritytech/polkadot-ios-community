...
>: UIView {
    ...
    private(set) var mainActionButton: RoundedButton?
    private(set) var secondaryActionButton: RoundedButton?
    ...
    func setupMainActionButton(for _: MessageSheetAction.ActionType) {

...
class RemoteSubscriptionService {
    ...
    func attachToSubscription(
        ...
        if let active = activeSubscriptions[params.cacheKey] {
        ...
        if let pending = pendingSubscriptions[params.cacheKey] {
        ...
        let wrapper = subscriptionOperation(
            using: params.requests,
            chainId: params.chainId,
            cacheKey: params.cacheKey,
            subscriptionHandlingFactory: params.handlingFactory,
            logger: logger
        )
        ...
        pendingSubscriptions[params.cacheKey] = pending

        operationQueue.addOperations(wrapper.allOperations, waitUntilFinished: false)

        logger.debug("Operations enqued for subscription: \(params.chainId)")
    ...
    private func subscriptionOperation(
        ...
        cacheKey: String,
        subscriptionHandlingFactory: RemoteSubscriptionHandleFactoryProtocol,
        logger: LoggerProtocol

...
final class BlockTimeOperationFactory {
    ...
    static let fallbackBlockRelaychainTime: BlockTime = 6_000
    static let fallbackBlockParachainTime: BlockTime = 2 * 6_000
...
extension BlockTimeOperationFactory: BlockTimeOperationFactoryProtocol {
    func createBlockTimeOperation(
        ...
        let mapOperation = ClosureOperation<BlockTime> {
            ...
            let estimatedPart = TimeInterval(boundedSeqSize) * estimatedBlockTimeValue.blockTime.millisecondsToSeconds()

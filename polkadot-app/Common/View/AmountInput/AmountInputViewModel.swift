...
protocol AmountInputViewModelProtocol: AnyObject {
    ...
    var observable: ViewModelObserverContainer<AmountInputViewModelObserver> { get }
...
final class AmountInputViewModel: AmountInputViewModelProtocol, MoneyPresentable {
    ...
    var observable: ViewModelObserverContainer<AmountInputViewModelObserver>
    ...
    init(
        ...
        observable = ViewModelObserverContainer()

        guard
            let amount, amount <= limit,
